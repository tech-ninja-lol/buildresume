        ...
        <div className='w-full text-[14px] shadow-md p-6 my-8 border border-gray-200 mx-auto flex flex-col'>
          ...
          <div id='contact' className='flex my-4 space-x-16'>
              ...
              <div>
                  ...
                  <h3>Github : <span>https://github.com/hadeeny</span></h3>
              </div>
          </div>
            {/* Contact Ends */}
            ...
            <div className='mb-4'>
                <p>
                    ...
                    explicabo nisi eveniet quaerat iure temporibus, impedit cum quia animi maiores 
                    incidunt omnis error similique cumque inventore vero commodi aut?
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem ipsum 
                    explicabo nisi eveniet quaerat iure temporibus, impedit cum quia animi maiores 
                    incidunt omnis error similique cumque inventore vero commodi aut?
                </p>
            ...
            <div className='border-t py-4 border-gray-300'>
                <ul className='space-y-4'>
                    ...
                    <li className='flex  justify-between'>
                        <div className='w-2/12 font-medium' id='date'>2003/3 - 2020/11</div>
                        <div className='w-9/12'>
                            <h2 id='position' className='text-lg text-black/90 font-medium'>Frontend engineer</h2>
                            <h3 className='text-md text-black/90 font-bold'>Twitter Inc</h3>
                            <p className='my-2 '>
                                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Delectus 
                                itaque dignissimos consectetur nam nobis placeat nesciunt expedita quidem maxime ad, 
                                velit amet quos consequuntur, rerum commodi cumque neque, voluptas ipsa.
                            </p>
                        </div>
                    </li>
                    {/* Experience 1 ends */}
