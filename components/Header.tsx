    ...
    <>
      <nav className="w-10/12 z-[100] h-[60px]  py-2 mx-auto">
        <div className="flex justify-between items-center">
            <Link href='/'>
                <h2 className='text-4xl font-bold'>Resume<span className='text-vert'>A</span></h2>
            </Link>
            <ul className='hidden text-lg md:flex space-x-8'>
                ...
                <Link  href='/template'>
                <li id='template' className='target:text-vert focus:text-vert'>Free CV template</li>
                </Link>
                <Link href='/resume'>
                <li>Resume</li>
                </Link>
            ...
            <div onClick={()=>{
                ...
                <div className={`w-8 duration-500 h-1 ${toggleMenu && '-rotate-45 '} bg-vert`}/>
                <div className={`w-8 h-1 duration-500 ${toggleMenu && 'w-0'} bg-vert`}/>
                <div className={`w-8 h-1 duration-500 ${toggleMenu && 'rotate-45'} bg-vert`}/>
            </div>
        </div>
      </nav>
      {/* Mobile Menu */}
